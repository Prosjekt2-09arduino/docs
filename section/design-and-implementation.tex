...
\section{System architecture}
	...
	The \textit{Service} holds and manages the Bluetooth connection (\textit{BluetoothConnection}) and is managing the protocol for installing apps on the microcontroller. \\

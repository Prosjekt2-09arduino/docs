...
\section{System Architecture}
	...
	\captionof{image}{Over The Air Architecture}
	\end{figure}
...
\captionof{image}{Screen 1a - Device list}
\end{image}
...
\captionof{image}{Screen 1b - Add device manually}
\end{image}
...
\captionof{image}{Screen 1b-i - Input serial}
\end{image}
...
\captionof{image}{Screen 2a - Browse shop}
\end{image}
...
\captionof{image}{Screen 2b - Browse shop by category}
\end{image}
...
\captionof{image}{Screen 3a - Application view}
\end{image}
...
\captionof{image}{Screen 3a-i - Installation confirmation}
\end{image}
...
\captionof{image}{Screen 3a-ii - Progress of installation}
\end{image}
...
\captionof{image}{Screen Xa - Action overflow}
\end{image}

...
Each iteration results in a increment, which is a release of the system that is and improvement of the previous iteration.
...
The last phase: Transition phase, is where the system is deployed to the target users. Feedback might result in further refinements. This step could also include user training which was descided to not be done. This was because the system should be user friendly and easy to understand.

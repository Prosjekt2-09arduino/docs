...
\caption{Visualization of the Rational Unified Process phases and disciplines involved}
\label{fig:rup}
\end{figure}
...
\caption{Screenshots from the Google Play Store showing their graphical user interface throughout the application.}
...
\caption{Pebble Watches with different applications changing the watch-faces.}
...
\caption{How a Bluetooth$\textsuperscript{\textregistered}$ piece is connected on an Arduino$\texttrademark$ device.}

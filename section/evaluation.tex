...
\section{Interaction with the customer}
	Regular meetings with the customer was scheduled every Friday throughout the project. In these meetings the group presented the status and progress of the project, and discussed problems that was encountered. In these meetings the customer were able to aid the group in decisions and give input on the prototypes of the product. Apart from these regular meetings the communication with the customer was done by e-mail. If difficult problems were encountered, or hard decisions had to be made, the group were always able to achieve help from the customer. Extraordinary meetings could be scheduled at short notice if needed, and the customer were willing to request help from external developers if the group requested it.
...
\section{Group interaction}
	...
	In addition to these regular meetings the group scheduled working sessions continuously. The guidelines for the project stated that each group member should work approximately 20 hours each week, which means at least three full days of work per group member each week. As described in chapter \ref{communication}, interaction outside group meetings were mainly done by e-mail or on Skype. In Table~\ref{table:workhours} the total work hours for the group on every iteration is listed. The reduction of hours in iteration 4 was due to the Easter holidays. \\
	\newline
